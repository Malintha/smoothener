...
% read input files
EXAMPLE = '/home/mark/act/smoothener/examples/move_29_3/move_29_3';
...
conf_ellipsoids = conf_ellipsoids .* 0.5;
obs_ellipsoids = obs_ellipsoids .* 0.5;

% obs_ellipsoids = repmat([0.1 0.1 0.1],N,1);
% conf_ellipsoids = obs_ellipsoids;
% schedule = schedule(:,:,5:N);
% conf_ellipsoids = conf_ellipsoids(5:N,:);
% obs_ellipsoids = obs_ellipsoids(5:N,:);
