...
% read input files
discrete_plan_file = 'examples/2windows_29_3/2windows_29_3_sol.json';
octree_file = 'examples/2windows_29_3/2windows.bt';
...
if (PLOTTING)
    ...
    stl_file = 'examples/2windows_29_3/2windows.stl';
    fv = stlread(stl_file);
    patch(fv, ...
